...
local cameraPitch = 0.18
	...
	local blipCodeMechanicTags = { "resource_loop", "market_sale", "hud_feedback", "social_join_scaffold", "pickaxe_action", "resource_respawn", "speed_tuning" }
	...
	local blipCodeSourceSummary = "Structured mechanic tags compile into allowlisted Blip runtime hooks for movement setup, camera follow, pickaxe mining, resource collection, inventory display, market sale feedback"
...
Client.OnStart = function()
    ...
    applyWorldMood()
	    ...
	    worldObjectiveLabel = makeWorldText("world_objective_label", "Goal: Mine crystals stone and gold with the pickaxe fill the inventory then reach the glowing ", Color(255, 235, 120), { 8, 5, 52 }, 0.08)
    ...
    objectiveText = ui:createText("Goal: Mine crystals stone and gold with the pickaxe fill the inventory then reach the glowing ", Color(255, 235, 120), "small")
