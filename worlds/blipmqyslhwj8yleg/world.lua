...
Client.OnStart = function()
    ...
    worldObjectiveLabel = makeWorldText("world_objective_label", "Goal: Mine resources with the pickaxe fill the inventory with crystals stone and gold then rea", Color(255, 235, 120), { 8, 5, 52 }, 0.08)
    ...
    objectiveText = ui:createText("Goal: Mine resources with the pickaxe fill the inventory with crystals stone and gold then rea", Color(255, 235, 120), "small")
