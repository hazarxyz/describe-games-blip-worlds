...
local cameraPitch = 0.18
	...
	local blipCodeMechanicTags = { "resource_loop", "market_sale", "hud_feedback", "social_join_scaffold", "pickaxe_action", "resource_respawn", "goal_pad_feedback", "speed_tuning" }
	...
	local blipCodeSourceSummary = "Structured mechanic tags define a first playable mining loop: spawn players in a small valley, show resource nodes, allow pickaxe swings within mining reach, update inventory feedb"
...
Client.OnStart = function()
    ...
    applyWorldMood()
	    ...
	    worldObjectiveLabel = makeWorldText("world_objective_label", "Goal: Mine crystal stone and gold with the pickaxe fill the inventory then reach the glowing m", Color(255, 235, 120), { 8, 5, 52 }, 0.08)
    ...
    objectiveText = ui:createText("Goal: Mine crystal stone and gold with the pickaxe fill the inventory then reach the glowing m", Color(255, 235, 120), "small")
