...
local cameraPitch = 0.18
	...
	local blipActionEffects = { "tool_swing", "resource_pop", "market_burst", "crystal_glow", "coin_ping" }
	local blipCodeMechanicTags = { "resource_loop", "market_sale", "hud_feedback", "social_join_scaffold", "pickaxe_mining", "node_respawn", "resource_respawn", "speed_tuning" }
	...
	local blipCodeSourceSummary = "Structured mechanic tags compile into allowlisted Blip runtime hooks for pickaxe mining, inventory gain, resource respawn, market selling, HUD feedback, camera follow, and multipla"
...
Client.OnStart = function()
    ...
    applyWorldMood()
	    ...
	    worldObjectiveLabel = makeWorldText("world_objective_label", "Goal: Mine resources with the pickaxe fill the inventory and reach the glowing market pad to s", Color(255, 235, 120), { 8, 5, 52 }, 0.08)
	    ...
	    worldCodeContractLabel = makeWorldText("world_code_contract_label", "Code: structured no raw lua | resource loop market sale hud feedback social join scaffold pickaxe mini", Color(190, 180, 255), { 8, 2, 52 }, 0.065)
    ...
    objectiveText = ui:createText("Goal: Mine resources with the pickaxe fill the inventory and reach the glowing market pad to s", Color(255, 235, 120), "small")
