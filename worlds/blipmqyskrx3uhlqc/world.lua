...
Client.OnStart = function()
    ...
    worldObjectiveLabel = makeWorldText("world_objective_label", "Goal: Use the pickaxe to mine crystal stone and gold resource nodes collect them into the inve", Color(255, 235, 120), { 8, 5, 52 }, 0.08)
    ...
    objectiveText = ui:createText("Goal: Use the pickaxe to mine crystal stone and gold resource nodes collect them into the inve", Color(255, 235, 120), "small")
