...
local cameraPitch = 0.18
	...
	local blipActionEffects = { "tool_swing", "resource_pop", "market_burst", "coin_ping", "node_glow" }
	local blipCodeMechanicTags = { "resource_loop", "market_sale", "hud_feedback", "social_join_scaffold", "camera_follow", "pickaxe_action", "resource_respawn", "speed_tuning" }
	...
	local blipCodeSourceSummary = "Structured mechanic tags compile into allowlisted Blip runtime hooks for spawning the valley, handling pickaxe mining, tracking inventory, updating HUD feedback, respawning resourc"
...
Client.OnStart = function()
    ...
    applyWorldMood()
	    ...
	    worldObjectiveLabel = makeWorldText("world_objective_label", "Goal: Mine crystal stone and gold nodes with the pickaxe collect at least 5 resources then rea", Color(255, 235, 120), { 8, 5, 52 }, 0.08)
	    ...
	    worldCodeContractLabel = makeWorldText("world_code_contract_label", "Code: structured no raw lua | resource loop market sale hud feedback social join scaffold camera follo", Color(190, 180, 255), { 8, 2, 52 }, 0.065)
    ...
    objectiveText = ui:createText("Goal: Mine crystal stone and gold nodes with the pickaxe collect at least 5 resources then rea", Color(255, 235, 120), "small")
